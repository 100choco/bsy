	...
	<div class="wrapper">
		...
		<jsp:include page="/include/bsymainhead.jsp"></jsp:include>
			...
			<div class="block">
				...
				<div class="gal">
					<button type="button" id="boardbtn" class="btn btn-outline-info" onclick="location.href='ReadBoardAllController'"><h2>공개 갤러리</h2></button>
				</div>
						...
						<c:choose>
							<c:when test="${id == null }">
								<form action="userLoginController" method="post">  <!-- 미구현 -->
									...
									<table>
										<tr>
											<td>아이디 : </td><td><input type="text" name="id"></td><td rowspan="2"><input type="submit" value="로그인"></td>
										</tr>
